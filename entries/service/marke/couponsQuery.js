    ...
    function ($,Class,template) {
        var search=Class.create({
            ...
            loadDate: function (callBack) {
                ...
                $.ajax({
                    url:Poss.baseUrl("/marketing/coupons"),
                    type:"GET",
                    dataType:"json",
            ...
            loadSerach: function (_this) {
                $("#coupons-button").on("click", function () {
                    _this.searchVild(function (date) {
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $("#couponsQuery").find(".coupons-table").empty();
                                $("#couponsQuery").find(".coupons-table").append(html);
            ...
            searchVild: function (callback) {
                ...
                coupons_query.find(":text").each(function () {
                    date[$(this).attr("data-name")]=$(this).val();
                });
                Poss.selectVal(coupons_query,date);
                callback(date);
            },
            //新增
